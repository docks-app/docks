...
describe Docks::Processors::BreakApartOnCommasSpacesAndPipes do
  subject { Docks::Processors::BreakApartOnCommasSpacesAndPipes }
  ...
  it 'correctly splits on internal spaces' do
